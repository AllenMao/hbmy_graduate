...
void CFrustum::Update( D3DXMATRIX *view )
{
...
//-----------------------------------------------------------------------------
void CFrustum::SetProjectionMatrix( D3DXMATRIX projection )
{
...
//-----------------------------------------------------------------------------
bool CFrustum::IsBoxInside( D3DXVECTOR3 min, D3DXVECTOR3 max )
{
	for( char p = 0; p < 5; p++ )
	{
...
// Returns true if the given box is inside the view frustum.
//-----------------------------------------------------------------------------
bool CFrustum::IsBoxInside( D3DXVECTOR3 translation, D3DXVECTOR3 min, D3DXVECTOR3 max )
{
...
//-----------------------------------------------------------------------------
bool CFrustum::IsSphereInside( D3DXVECTOR3 translation, float radius )
{
	for( char p = 0; p < 5; p++ )
