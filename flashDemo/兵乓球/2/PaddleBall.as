 package {
	...
	public class PaddleBall extends MovieClip {
		...
		private const ballRadius:Number = 9;//在离砖头多近的地方能够有反应
		...
		private const paddleWidth:Number = 90;//落在板上能够击球的范围
		private const ballSpeed:Number = .2;
		private const paddleCurve:Number = .005;//击球后球的速度
		private const paddleHeight:Number = 18;//离板多高的地方能够击球
		...
		// bricks
		private var bricks:Array;//砖头的个数
		...
		public function startPaddleBall() :void {
		...
		public function newBall(e: MouseEvent) {
