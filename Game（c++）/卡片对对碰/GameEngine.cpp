...
BOOL	GameEngine::CreateGameWindow()
{
	...
	wcApp.hCursor=LoadCursor(m_hInstance, MAKEINTRESOURCE(m_wCursor));			//加载鼠标样式
...
{	
	...
	return DefWindowProc(hWnd,message,wParam,lParam);//对OS进行缺省处理
}
